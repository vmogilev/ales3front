...
docker build -t alesi2/ales3front:dev .
docker tag alesi2/ales3front:dev 639518868771.dkr.ecr.us-east-1.amazonaws.com/alesi2/ales3front:dev

aws ecr get-login --region us-east-1 > /tmp/dockerlogin.sh
sh /tmp/dockerlogin.sh
rm -f /tmp/dockerlogin.sh

docker push 639518868771.dkr.ecr.us-east-1.amazonaws.com/alesi2/ales3front:dev
